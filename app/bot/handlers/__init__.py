...
bot_commands = (
    ...
    ("key_binance", "Установить апи ключ на binance"),
    ("secret_binance", "Установить апи сикрет на binance"),
    ("key_bybit", "Установить апи ключ на bybit"),
    ("secret_bybit", "Установить апи сикрет на bybit"),
)
